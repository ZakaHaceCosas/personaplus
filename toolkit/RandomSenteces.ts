 ...
 *
 * @export
 * @param {("allObjectivesDone" | "sessionCompleted" | "activeObjectiveReminders" | "createActiveObjective")} target The type of random message you're seeking. It uses the name of the `translations/*.json` files, e.g. "`allObjectivesDone`" will return a random message from `coolRandomMessages.allObjectivesDone`.
